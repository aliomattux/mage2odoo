...
DEFAULT_JOBS = [
		 ...
		 'mapping_name': 'Product',
		 'mapping_lines': PRODUCT_DEFAULT_MAP},
                {'name': 'Sync Admin Users',
                 'mapping_model_name': '',
                 'python_function_name': 'sync_admin_users',
                 'job_type': 'system',
                 'scheduler': False,
                 'mapping_name': '',
                 'mapping_lines': ''},
		 ...
		 'mapping_model_name': '',
                ...
                {'name': 'Auto Billing',
                 'mapping_model_name': '',
                 'python_function_name': 'autopay_sale_orders',
                 'job_type': 'system',
                 'scheduler': False,
                 'mapping_name': '',
                 'mapping_lines': ''},
                {'name': 'Auto Only Shipping',
                 'mapping_model_name': '',
                 'python_function_name': 'automate_only_pickings',
                 'job_type': 'system',
                 'scheduler': False,
                 'mapping_name': '',
                 'mapping_lines': ''},
                {'name': 'Auto Sale Shipping',
                 'mapping_model_name': '',
                 'python_function_name': 'autodeliver_sale_orders',
                 'job_type': 'system',
                 'scheduler': False,
                 'mapping_name': '',
                 'mapping_lines': ''},
                {'name': 'Sync Product Links',
                 'mapping_model_name': '',
                 'python_function_name': 'import_product_links',
                 'job_type': 'system',
                 'scheduler': False,
                 'mapping_name': '',
                 'mapping_lines': ''},
